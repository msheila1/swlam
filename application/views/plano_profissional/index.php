...
<head>
    <meta charset="utf-8">
    <title>Swlam - Plano Profissional</title>
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <meta name="description" content="">
    <meta name="author" content="Swlam Sistemas">
    ...
    <div class="container">
        <div class="row">
            <div class="span11 offset1">
                <div>
                    <h2><strong>Contratar plano Profissional</strong></h2>
                    ...
                    <div class="container">
                       <div class="row">
                        ...
                        <div class="span3">
                            <div class="field form-group">
                            <p><button type="button" class="btn btn-info">Plano Profissional</button></p>
